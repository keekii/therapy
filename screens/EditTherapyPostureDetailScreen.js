...
const EditTherapyPostureDetailScreen = ({ navigation }) => {
  const { updateTherapyPostureById, clearErrorMessage } = useContext(TherapyPostureContext);
    ...
    <View style={styles.container}>
      ...
      <View>
        ...
        <TouchableOpacity
          ...
          onPress={() => updateTherapyPostureById(key,name, description, thumbnail, video)}
        >
...
export default EditTherapyPostureDetailScreen;
