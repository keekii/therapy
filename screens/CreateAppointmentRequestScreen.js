...
const CreateAppointmentRequestScreen = ({ navigation }) => {
  const {
    state,
    getTherapistList,
  ...
  const { therapistList, userProfile } = state;

  useEffect(() => {
    getTherapistList(input, 5);
    getProfile();
  ...
  return (
    <>
      <View style={styles.topBox}>
        <Text style={styles.topLabel}>CREATE NEW APPOINTMENT REQUEST</Text>
...
export default CreateAppointmentRequestScreen;
