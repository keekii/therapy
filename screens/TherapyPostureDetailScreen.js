...
const TherapyPostureDetailScreen = ({ navigation }) => {
  const { state, deleteTherapyPostureById } = useContext(TherapyPostureContext);
           ...
           >
             ...
             <TouchableOpacity
               ...
               onPress={() => {
                 ...
                 deleteTherapyPostureById(therapyPosture['key']);
               }}
             >
...
export default TherapyPostureDetailScreen;
