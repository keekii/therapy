...
const AppointmentRequestDetailScreen = ({ navigation }) => {
  const { state, rejectAppointmentRequest, acceptAppointmentRequest } = useContext(
    CalendarContext
  );
  ...
  return (
    <>
      ...
      <ScrollView style={styles.container}>
        <View style={styles.midBox}>
          ...
          >
            <Image
              style={styles.image}
              source={{ uri: data['therapist'] && data['patient']['profile_pic'] }}
            />

            <Text style={styles.name}>{data['patient'] && data['patient']['name']}</Text>
          </View>
        </View>
      </ScrollView>
      {data && data['status'] != 'accepted' && <View style={styles.bottomBox}>
        <TouchableOpacity
              ...
              >
                ...
                <TouchableOpacity
                  ...
                  onPress={() => {
                    ...
                    rejectAppointmentRequest(data['key']);
                  }}
                >
      ...
      <Modal onRequestClose={() => setModalVisible2(false)} visible={modal2}>
        <View
          style={{
            height: "100%",
            justifyContent: "center",
...
export default AppointmentRequestDetailScreen;
