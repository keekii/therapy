...
const AdminEditTherapyPostureDetailScreen = ({ navigation }) => {
  const { updateTherapyPostureById2, clearErrorMessage } = useContext(TherapyPostureContext);
  ...
  useEffect(() => {
    ...
    setKey(data['key']);
    setName(data['therapy_posture_name']);
    setDescription(data['therapy_posture_description']);
    setThumbnail(data['therapy_posture_thumbnail_image']);
    setVideo(data['therapy_posture_video']);
  }, []);
  ...
  return (
    ...
    <View style={styles.container}>
      ...
      <View style={styles.logoContainer}>
        <Text style={styles.text}>Edit the therapy posture details</Text>
      </View>
      <View>
        ...
        <TouchableOpacity
          ...
          onPress={() => updateTherapyPostureById2(key,name, description, thumbnail, video)}
        >
...
export default AdminEditTherapyPostureDetailScreen;
