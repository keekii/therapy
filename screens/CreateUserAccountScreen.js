...
const CreateUserAccountScreen = ({ navigation }) => {
  ...
  return (
    ...
    <View style={styles.container}>
      ...
      <View style={styles.logoContainer}>
        <Text style={styles.text}>CREATE NEW USER ACCOUNT</Text>
      </View>
      <ScrollView>
        ...
        <View style={styles.bottomBox}>
          <TouchableOpacity
            ...
            onPress={() => storeUserAccount(name, surname, email, password, id, phone, address, dob, gender, role)}
          >
