...
const CreateTherapyPostureScreen = ({ navigation }) => {
  const { storeTherapyPosture, clearErrorMessage } = useContext(TherapyPostureContext);
    ...
    <View style={styles.container}>
      ...
      <View>
        ...
        <TouchableOpacity
          ...
          onPress={() => storeTherapyPosture(name,description,thumbnail,video)}
        >
...
export default CreateTherapyPostureScreen;
